-- Fix templates table structure to handle multiple content types

-- First, make html_content nullable to support SMS and physical templates
...
-- Clear any existing default templates to avoid conflicts
